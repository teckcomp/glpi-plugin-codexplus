...
| R3b3 | Imagens coladas, anexos, página de leitura com os cinco seletores do PDF e exportação em PDF. **R3b3-1** imagem colada e anexos ✅ pacote `codexplus-r3b3-anexos-2`; **R3b3-2** leitura e PDF do documento novo | POP com imagem e anexo, publicado e exportado |
