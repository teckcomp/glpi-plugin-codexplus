...
function plugin_init_codexplus(): void
{
    ...
    $PLUGIN_HOOKS[Hooks::ADD_JAVASCRIPT]['codexplus'] = ['js/codexplus.js', 'js/codexplus-org.js', 'js/codexplus-grid.js', 'js/codexplus-perm.js', 'js/codexplus-docform.js', 'js/codexplus-editor.js', 'js/codexplus-sheet.js', 'js/codexplus-icons.js', 'js/codexplus-board.js', 'js/codexplus-export.js', 'js/codexplus-annotate.js'];
}
/**
 * Metadados do plugin.
 */
